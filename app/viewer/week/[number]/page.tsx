      ...
      <div className="space-y-8">
        ...
        {week.buildSection && (
          <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800">
            <BuildSectionComponent buildSection={week.buildSection} />
          </div>
        )}
        ...
        {week.researchSection && (
          <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800">
            <ResearchSectionComponent researchSection={week.researchSection} />
          </div>
        )}
        ...
        {week.shareSection && (
          <div className="bg-white dark:bg-gray-900 rounded-lg p-6 border border-gray-200 dark:border-gray-800">
            <ShareSectionComponent shareSection={week.shareSection} />
          </div>
        )}
      </div>
