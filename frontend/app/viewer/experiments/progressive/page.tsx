...
function ProgressiveExperimentContent() {
    ...
    return <ProgressiveRoadmap roadmap={displayRoadmap} />;
}

export default function ProgressiveExperimentPage() {
    return (
        <Suspense fallback={<div>Loading...</div>}>
            <ProgressiveExperimentContent />
        </Suspense>
    );
}
