...
import MorphingRoadmap from '@/components/experiments/MorphingRoadmap';
import roadmapData from '@/final_roadmap.json';
import { Roadmap } from '@/lib/types';

function MorphingExperimentContent() {
    ...
    return <MorphingRoadmap roadmap={displayRoadmap} />;
}

export default function MorphingExperimentPage() {
    return (
        <Suspense fallback={<div>Loading...</div>}>
            <MorphingExperimentContent />
        </Suspense>
    );
}
