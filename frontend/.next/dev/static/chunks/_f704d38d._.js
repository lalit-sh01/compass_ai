...
"[project]/lib/validator.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function initializeValidator() {
    ...
    try {
        ...
        ajvInstance = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$ajv$2f$dist$2f$ajv$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]({
            allErrors: true,
            verbose: true,
            strict: false
        });
...
_s(useApiClient, "TZyIvyGBnam54p/7H4rjGZDRcCU=", false, function() {
    return [
...
"[project]/context/RoadmapContext.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/validator.ts [app-client] (ecmascript)");
...
function RoadmapProvider({ children }) {
    ...
    const [validatorInitialized, setValidatorInitialized] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    //   init();
    // }, []);
    const loadRoadmap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoadmapProvider.useCallback[loadRoadmap]": async (source)=>{
            ...
            try {
                ...
                if (typeof source === 'string') {
                    // Load from URL
                    result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loadRoadmapFromURL"])(source);
                } else {
                    // Load from File
                    const text = await source.text();
                    result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$validator$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["validateRoadmapJSON"])(text);
                }
    ...
    }["RoadmapProvider.useCallback[loadRoadmap]"], [
    ...
    const loadRoadmapById = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoadmapProvider.useCallback[loadRoadmapById]": async (roadmapId)=>{
            setLoading(true);
            setError(null);
            try {
    ...
    }["RoadmapProvider.useCallback[loadRoadmapById]"], []); // eslint-disable-line react-hooks/exhaustive-deps
    const setRoadmapDirect = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoadmapProvider.useCallback[setRoadmapDirect]": (roadmap)=>{
            setRoadmap(roadmap);
            setError(null);
        }
    }["RoadmapProvider.useCallback[setRoadmapDirect]"], []);
    const clearRoadmap = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "RoadmapProvider.useCallback[clearRoadmap]": ()=>{
            setRoadmap(null);
            setError(null);
            setFilters({});
        }
...
_s(RoadmapProvider, "D/JdoD7YmAm35u550e1MYHM4DLE=", false, function() {
    return [
...
_s1(useRoadmap, "b9L3QQ+jgeyIrH0NfHrJ8nn7VMU=");
var _c;
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$clerk$2d$react$2f$dist$2f$chunk$2d$MV5LDDHP$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@clerk/clerk-react/dist/chunk-MV5LDDHP.mjs [app-client] (ecmascript)");
"use client";
;
;
function UserMenu() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$clerk$2f$clerk$2d$react$2f$dist$2f$chunk$2d$MV5LDDHP$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["UserButton"], {
        appearance: {
            elements: {
                avatarBox: "h-9 w-9",
...
function Header() {
    ...
    const { roadmap, clearRoadmap } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$RoadmapContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRoadmap"])();
...
_s(Header, "JlWq0SNjxBoFN1GjddRo2+hiP+Y=", false, function() {
    return [
...
//# sourceMappingURL=_f704d38d._.js.map